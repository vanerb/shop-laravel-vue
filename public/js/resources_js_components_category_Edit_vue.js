...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _this.axios.get("/api/category/".concat(_this.$route.params.id)).then(function (response) {
    ...
    actualize: function actualize() {
      var _this2 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _this2.axios.put("/api/category/".concat(_this2.$route.params.id), _this2.category).then(function (response) {
                _this2.$router.push({
                  name: "showcategory"
                });
              })["catch"](function (error) {
  ...
  return _c("div", {
    ...
    on: {
      submit: function submit($event) {
        ...
        return _vm.actualize.apply(null, arguments);
      }
    }
  }, [_c("div", {
